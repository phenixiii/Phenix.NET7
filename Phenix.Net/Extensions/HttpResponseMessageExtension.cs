        ...
        public static async Task ThrowIfFailedAsync(this HttpResponseMessage message)
        {
            ...
            switch (message.StatusCode)
            {
                ...
                case HttpStatusCode.Conflict: //等效于 HTTP 状态 409 -> 服务器在完成请求时发生冲突
                    throw new Phenix.Mapper.Rule.ValidationException(Utilities.JsonDeserialize<Phenix.Mapper.Rule.ValidationMessage>(await message.Content.ReadAsStringAsync()));
