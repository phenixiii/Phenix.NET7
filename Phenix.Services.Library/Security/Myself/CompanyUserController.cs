...
namespace Phenix.Services.Library.Security.Myself
{
    ...
    public sealed class CompanyUserController : Phenix.Core.Net.Api.ControllerBase
    {
        ...
        {
            return await EncryptAsync(Phenix.Services.Library.Security.User.FetchList(Database.Default,
                includeDisabled
                ...
                OrderBy.Ascending<Phenix.Services.Library.Security.User>(p => p.RegAlias)));
        }
