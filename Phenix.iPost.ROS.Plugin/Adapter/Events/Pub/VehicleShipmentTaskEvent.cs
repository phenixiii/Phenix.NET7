...
namespace Phenix.iPost.ROS.Plugin.Adapter.Events.Pub
{
    ...
    [Serializable]
    public record VehicleShipmentTaskEvent(string MachineId, string TaskId, TaskStatus TaskStatus,
            VehicleShipmentOperationStatus OperationStatus)
        : VehicleTaskEvent(MachineId, TaskId, TaskStatus, VehicleTaskType.ShipmentOperation);
}