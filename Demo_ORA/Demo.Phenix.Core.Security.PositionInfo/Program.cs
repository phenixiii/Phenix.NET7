...
namespace Demo
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("你可以基于此（通过调用 Position 类公共函数）开发自己系统的岗位配置管理模块，然后开放权限给到系统SaaS管理员使用。");
            Console.WriteLine("系统SaaS管理员凌驾于使用系统的企业（RootTeams），对岗位（Position）的配置结果会影响到所有企业的系统用户（User）。");
            Console.WriteLine();
