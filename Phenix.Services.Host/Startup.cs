    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                 ...
                 */
                endpoints.MapHub<Phenix.Services.Plugin.Message.GroupMessageHub>(Phenix.Services.Contract.WebApiConfig.ApiMessageGroupMessageHubPath);
                endpoints.MapHub<Phenix.Services.Plugin.Message.UserMessageHub>(Phenix.Services.Contract.WebApiConfig.ApiMessageUserMessageHubPath);
            });
        }
    }
}