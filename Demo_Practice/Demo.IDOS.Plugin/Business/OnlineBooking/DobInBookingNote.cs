...
namespace Demo.IDOS.Plugin.Business.OnlineBooking
{
    ...
    public class DobInBookingNote : EntityBase<DobInBookingNote>
    {
        ...
        public DobInBookingNote(long id, long bdId, string bookingNumber, BookingStatus bookingStatus, long cmId, string goodsNumber, string goodsType, GoodsSize goodsSize, string goodsClass, string licensePlate, long originator, DateTime originateTime, long updater, DateTime updateTime) 
        {
            _id = id;
            _bdId = bdId;
