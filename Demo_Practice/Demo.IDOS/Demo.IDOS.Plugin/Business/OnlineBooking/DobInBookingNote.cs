...
/* 
   ...
   mapping to: dob_in_booking_note
*/
...
namespace Demo.IDOS.Plugin.Business.OnlineBooking
{
    ...
    /// </summary>
    [System.Serializable]
    [System.ComponentModel.DataAnnotations.Display(Description = "入库预约单")]
    public class DobInBookingNote : EntityBase<DobInBookingNote>
    {
        private DobInBookingNote()
        {
            // used to fetch object, do not add code
        }

        [Newtonsoft.Json.JsonConstructor]
        public DobInBookingNote(string dataSourceKey, long id,
            DateTime date, short dateTimeSlot, string bookingNumber, BookingStatus bookingStatus, long dpId, long cmId, string goodsNumber, string goodsType, GoodsSize goodsSize, string goodsClass, string licensePlate, long originator, DateTime originateTime, long updater, DateTime updateTime)
